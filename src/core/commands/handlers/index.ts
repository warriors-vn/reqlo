...
export function registerBuiltInCommands(): () => void {
  const cmds: CommandDescriptor[] = [
    ...
    {
      id: "view.toggle-request-panel",
      title: "Toggle Request Panel",
      description: "Collapse or expand the request panel, for more room for the response",
      category: "view",
      icon: PanelTop,
      shortcut: "mod+shift+d",
      when: (c) => c.hasActiveRequest,
      run: () => s().toggleRequestPanel(),
    },
    {
